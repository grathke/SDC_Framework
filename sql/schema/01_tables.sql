...
CREATE TABLE dbo.[FW_LicenseTerms] (
    ...
    [CreatedBy] int NULL,
    [CreatedOn] datetime NULL CONSTRAINT [DF_FW_LicenseTerms_CreatedOn] DEFAULT (sysutcdatetime()),
    [UpdatedBy] int NULL,
    [UpdatedOn] datetime NULL,
...
CREATE TABLE dbo.[FW_PageZooms] (
    ...
    [CreatedBy] int NULL,
    [CreatedOn] datetime NULL CONSTRAINT [DF_FW_PageZooms_CreatedOn] DEFAULT (sysutcdatetime()),
    [UpdatedBy] int NULL,
    [UpdatedOn] datetime NULL,
...
CREATE TABLE dbo.[FW_SavedQBE] (
    ...
    [CreatedOn] datetime2 NOT NULL CONSTRAINT [DF_FW_SavedQbe_CreatedOn] DEFAULT (sysutcdatetime()),
    [UpdatedOn] datetime2 NOT NULL CONSTRAINT [DF_FW_SavedQbe_UpdatedOn] DEFAULT (sysutcdatetime()),
...
CREATE TABLE dbo.[FW_TableLayouts] (
    ...
    [CreatedBy] int NULL,
    [CreatedOn] datetime NOT NULL CONSTRAINT [DF_FW_TableLayouts_CreatedOn] DEFAULT (sysutcdatetime()),
    [UpdatedBy] int NULL,
    [UpdatedOn] datetime NULL,
...
CREATE TABLE dbo.[FW_UpdateTabOrder] (
    ...
    [DeletedOn] datetime NULL,
    [CreatedBy] int NULL,
    [CreatedOn] datetime NOT NULL CONSTRAINT [DF_FW_UpdateTabOrder_CreatedOn] DEFAULT (sysutcdatetime()),
    [UpdatedBy] int NULL,
    [UpdatedOn] datetime NULL,
...
CREATE TABLE dbo.[FW_Users] (
    ...
    [Zip] varchar(10) NULL,
    [CreatedBy] int NULL,
    [CreatedOn] datetime NULL CONSTRAINT [DF__Users__CreatedOn__2BFE89A6] DEFAULT (sysutcdatetime()),
    [UpdatedBy] int NULL,
    [UpdatedOn] datetime NULL,
...
CREATE TABLE dbo.[FW_UserUiHints] (
    ...
    [SeenOn] datetime NOT NULL CONSTRAINT [DF_FW_UserUiHints_SeenOn] DEFAULT (sysutcdatetime()),
    [CreatedBy] int NULL,
    [CreatedOn] datetime NOT NULL CONSTRAINT [DF_FW_UserUiHints_CreatedOn] DEFAULT (sysutcdatetime()),
    [UpdatedBy] int NULL,
    [UpdatedOn] datetime NOT NULL CONSTRAINT [DF_FW_UserUiHints_UpdatedOn] DEFAULT (sysutcdatetime()),
