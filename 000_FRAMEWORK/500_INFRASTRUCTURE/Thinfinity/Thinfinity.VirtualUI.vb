...
Namespace Cybele.Thinfinity
    ...
    Public Interface IVirtualUI
        ...
        Function AuthenticateOAuth(ClientId As String, ClientSecret As String, AuthorizationUrl As String, AuthorizationParams As String, TokenValidationUrl As String, TokenValidationParams As String, ProfileInformationUrl As String, ProfileInformationParams As String) As String
    End Interface
    ...
    Public Interface IEvents
        ...
        <DispId(205)>
        Sub OnAuthentication(AuthMethod As String, Succeeded As Boolean, Data As String)
    End Interface
    ...
    Public Interface IBrowserInfo
        ...
        Sub SetCookieEx(Name As String, Value As String, Expires As String, Path As String, Options As String)
    End Interface
    ...
    Public Class VirtualUILibrary
        ...
        Private Shared Function GetDLLDir() As String
            ...
            End If
            If RegKey Is Nothing Then
                RegKey = Registry.LocalMachine.OpenSubKey("SOFTWARE\Wow6432Node\Cybele Software\Setups\Thinfinity\Workspace", False)
            End If
            If RegKey Is Nothing Then
                RegKey = Registry.LocalMachine.OpenSubKey("SOFTWARE\Cybele Software\Setups\Thinfinity\Workspace", False)
            End If
            If RegKey Is Nothing Then
                RegKey = Registry.LocalMachine.OpenSubKey("SOFTWARE\Wow6432Node\Cybele Software\Setups\Thinfinity\Workspace HyC", False)
            End If
            If RegKey Is Nothing Then
                RegKey = Registry.LocalMachine.OpenSubKey("SOFTWARE\Cybele Software\Setups\Thinfinity\Workspace HyC", False)
            End If
    ...
    Public Class BrowserInfo
        ...
        Public Sub SetCookieEx(Name As String, Value As String, Expires As String, Path As String, Options As String) Implements IBrowserInfo.SetCookieEx
            If m_VirtualUI IsNot Nothing Then
                m_VirtualUI.BrowserInfo.SetCookieEx(Name, Value, Expires, Path, Options)
            End If
        End Sub
    End Class
    ...
    Public Class AuthenticationArgs
        ...
        Public Property AuthMethod() As String
            ...
            End Set
        End Property
        Private m_AuthMethod As String
        Public Property Succeeded() As Boolean
            ...
            End Set
        End Property
        Private m_Succeeded As Boolean
...
#Region "VirtualUISink Members"
        ...
        End Sub
        Public Sub OnAuthentication(AuthMethod As String, Succeeded As Boolean, Data As String) Implements IEvents.OnAuthentication
            m_VirtualUI.OnAuthenticationEventHandler(AuthMethod, Succeeded, Data)
        End Sub
...
#End Region
    ...
    Public Class VirtualUI
        ...
        ''' <summary>
        '''   Register an authentication method for OAuth/2
        ''' </summary>
        Public Function AuthenticateOAuth(ClientId As String, ClientSecret As String, AuthorizationUrl As String, AuthorizationParams As String, TokenValidationUrl As String, TokenValidationParams As String, ProfileInformationUrl As String, ProfileInformationParams As String) As String
            If m_VirtualUI IsNot Nothing Then
                Return m_VirtualUI.AuthenticateOAuth(ClientId, ClientSecret, AuthorizationUrl, AuthorizationParams, TokenValidationUrl, TokenValidationParams, ProfileInformationUrl, ProfileInformationParams)
            Else
                Return ""
            End If
        End Function
        ...
        Public Custom Event OnAuthentication As EventHandler(Of AuthenticationArgs)
            AddHandler(ByVal value As EventHandler(Of AuthenticationArgs))
                If Not Me.Equals(g_virtualUI) Then
                    g_virtualUI.Events.AddHandler("OnAuthentication", value)
                    Return
                End If
                Me.Events.AddHandler("OnAuthentication", value)
            End AddHandler
            RemoveHandler(ByVal value As EventHandler(Of AuthenticationArgs))
                If Not Me.Equals(g_virtualUI) Then
                    g_virtualUI.Events.RemoveHandler("OnAuthentication", value)
                    Return
                End If
                Me.Events.RemoveHandler("OnAuthentication", value)
            End RemoveHandler
            RaiseEvent(ByVal sender As Object, ByVal args As AuthenticationArgs)
                If Not IsNothing(Me.Events("OnAuthentication")) Then
                    CType(Me.Events("OnAuthentication"), EventHandler(Of AuthenticationArgs)).Invoke(sender, args)
                End If
            End RaiseEvent
        End Event
        ...
        Friend Sub OnAuthenticationEventHandler(AuthMethod As String, Succeeded As Boolean, Data As String)
            Dim args As New AuthenticationArgs()
            args.AuthMethod = AuthMethod
            args.Succeeded = Succeeded
            args.Data = Data
            RaiseEvent OnAuthentication(Me, args)
        End Sub
    End Class
