...
Namespace SDC.Framework
    Public Class UsersY_B
        ...
        Protected Overrides Function HandleDefaultCreateAction() As Boolean
            Using page As New UsersY_U(0, currentUser, accessProfile)
        ...
        Protected Overrides Function HandleDefaultUpdateAction(recordId As Integer) As Boolean
            Using page As New UsersY_U(recordId, currentUser, accessProfile)
        ...
        Protected Overrides Function HandleDefaultDeleteAction() As Boolean
            ...
            Dim failure = DataAccess.SoftDeleteGeneratedPageRecord("FW_USERS",
                                                                  "UserId",
                                                                  recordId.Value,
