...
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "DeletedViewGuard.ResultHasDeletedFlagColumn(browseGrid)" -Description "Base browse uses shared result-column guard"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "DeletedViewGuard.TableSupportsDeletedView(tableName)" -Description "Base browse uses shared table deleted support guard"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "If col Is Nothing OrElse Not col.Visible Then" -Description "QBE derives fields only from visible browse columns"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "If IsPkAliasColumn(col) OrElse IsSoftDeleteColumnName(fieldName) Then" -Description "Grid-derived QBE excludes the internal PK alias"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern 'String.Equals(dc.ColumnName, "PK", StringComparison.OrdinalIgnoreCase)' -Description "Start Empty QBE excludes the internal PK alias"
if (Select-String -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern 'AssignedManagerID' -SimpleMatch -Quiet) {
...
if (Select-String -Path ".\000_FRAMEWORK\080_HELPDESK\HD_Issues_Support_B.vb" -Pattern "Inherits FW_HD_Issues_B|New FW_HD_Issues_B" -SimpleMatch -Quiet) {
    throw "FW_HD_Issues_Support_B must be independent of FW_HD_Issues_B."
}
Assert-Pattern -Path ".\000_FRAMEWORK\080_HELPDESK\HD_Issues_Support_B.vb" -Pattern "Inherits FW_Base_B" -Description "Support browse independently inherits shared Base_B"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "Return Me.GetType().Name" -Description "Browse pages use runtime class names for FW_RoleTables keys"
...
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern '"1. Request Name"' -Description "Page Generation question 1 uses Pascal-style display text"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern '"10. Use RegistrationID from selected table (N/A)"' -Description "Page Generation question 10 uses the correct RegistrationID SQL caption"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern '"2. Pages To Generate"' -Description "Page Generation question 2 uses Pascal-style display text"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'CheckBox_UseRegistrationID' -Description "Page Generation exposes the Use Registration ID checkbox"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'WHERE [RegistrationID] = @RegistrationID' -Description "Page Generation generates a parameterized RegistrationID filter when enabled"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern '9. Browse SQL' -Description "Page Generation SQL question uses Pascal-style display text"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern '10. Use RegistrationID from selected table' -Description "Page Generation Use RegistrationID question follows Browse SQL"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'New String() {"RequestName", "PageBaseName", "BrowsePageName", "MaintenancePageName", "UnderlyingTableName", "MenuCaller", "IconFileName", "BrowseSql"}' -Description "Page Generation Admin Required fields exclude the Use Registration ID checkbox"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'Admin Required labels use a trailing *' -Description "Page Generation directions document star-only Admin Required labels"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'labelControl.Text &= " *"' -Description "Page Generation Admin Required labels show an asterisk"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'textBox.Tag = "Required"' -Description "Page Generation Admin Required controls participate in shared validation"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'borderPanel.BackColor = If(isEmpty, Color.Red, SystemColors.Control)' -Description "Page Generation Admin Required controls have red empty-value borders"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern '.Size = New Size(120, 26)' -Description "Shared _U captions match the 26-pixel edit-control height"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'caption height matches the height of its edit control' -Description "Page Generation directions document the shared _U caption-height rule"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern '1-pixel red outline' -Description "Page Generation directions document the shared _U required-border rule"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern 'RefreshLocalRequiredBorders()' -Description "Shared _U refreshes local required borders during validation"
...
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'Run the browse framework preflight' -Description "Page Generation directions require browse framework preflight"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'Run a duplicate-logic check before generating the pages' -Description "Page Generation directions require duplicate-logic review"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'Run the applicable _B/_U regression checks' -Description "Page Generation directions require _B/_U regression checks"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'Build the application after the regression checks pass' -Description "Page Generation directions require a post-regression build"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern 'touchedRequiredControls.Add(control)' -Description "Shared AddField required borders activate only once a required control is visited"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern 'border.BackColor = If(showWarning, Color.Red, SystemColors.Control)' -Description "Shared AddField required borders refresh color with control values"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern 'If Not IsEmptyRequiredControl(control) Then Return False' -Description "Shared AddField required borders stay hidden while a required control holds a value"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern 'Return touchedRequiredControls.Contains(control) OrElse hoveredRequiredControls.Contains(control)' -Description "Shared AddField required borders show only once a required control is visited or hovered"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'Generated _U pages must inherit required-field styling and validation from FW_Base_U' -Description "Directions require generated pages to inherit required styling from Base_U"
Assert-Pattern -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern 'must not create page-local red-border panels' -Description "Directions prohibit generated page-local required-border duplication"
if (Select-String -Path ".\000_FRAMEWORK\070_PAGEGENERATION\PageGeneration_U.vb" -Pattern '"[0-9]+\. (RequestName|PageBaseName|BrowsePageName|MaintenancePageName|UnderlyingTableName|RegistrationID|EditableFields|ReadOnlyFields|LookupFields|AdminRequiredFields|CreateBehavior|UpdateBehavior|DeleteBehavior|MenuCaller|BrowseSql)"' -Quiet) {
...
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "UpsertPageRecord" -Description "Base browse persists generated fallback SQL"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "EnsureDefaultLayoutExists(registrationId)" -Description "Base browse ensures a shared default layout after the first successful grid load"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "updateButton.PerformClick()" -Description "Base browse double-click invokes the visible Modify button"
...
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern "If Not layoutChanged AndAlso Not String.IsNullOrWhiteSpace(existingLastUsed) Then" -Description "Base browse does not rewrite Last Used without a user layout change"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_B.vb" -Pattern '"LastUsed",' -Description "Base browse upserts Last Used when the grid JSON changed"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern "WarnIfMissingRowVersion" -Description "Base maintenance page warns on missing RowVersion"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern "CaptureOriginalRowVersion" -Description "Base maintenance page owns the original RowVersion"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern "CopyOriginalRowVersion" -Description "Base maintenance page provides RowVersion copies"
...
Assert-Pattern -Path ".\000_FRAMEWORK\080_HELPDESK\HelpDeskDataAccess.vb" -Pattern "Public Property UpdatedOn As DateTime?" -Description "Help Desk nullable update timestamp maps to a nullable model property"
Assert-Pattern -Path ".\000_FRAMEWORK\080_HELPDESK\HelpDeskDataAccess.vb" -Pattern '.UpdatedBy = NullableInt(reader("UpdatedBy"))' -Description "Help Desk safely reads a null update actor"
Assert-Pattern -Path ".\000_FRAMEWORK\080_HELPDESK\HelpDeskDataAccess.vb" -Pattern '.UpdatedOn = NullableDate(reader("UpdatedOn"))' -Description "Help Desk safely reads a null update timestamp"
...
Assert-Pattern -Path ".\100_PROJECTS\SDC\MenuFormInitializer.vb" -Pattern "menu.SetAccessProfile(profile)" -Description "Menu receives the active access profile"
...
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern "ConfirmConcurrencyOverwrite" -Description "Base maintenance flow requires explicit conflict choice"
Assert-Pattern -Path ".\000_FRAMEWORK\000_BASECLASSES\Base_U.vb" -Pattern "bypassCancelCloseCheck" -Description "Base maintenance page controls close-after-save behavior"
...
Assert-Pattern -Path ".\000_FRAMEWORK\010_MAINMENU\MainMenu.vb" -Pattern "SizeType.Percent, 33.0F" -Description "Other main-menu regions share the reduced width"
...
Assert-Pattern -Path ".\000_FRAMEWORK\080_HELPDESK\HD_Issues_U.vb" -Pattern "Conversation History" -Description "Help Desk update page provides conversation history"
