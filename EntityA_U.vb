...
Namespace HelloWorld
    Public Class EntityA_U
        ...
        Public Sub New(id As Integer, user As UserContext, Optional profile As AccessProfile = Nothing)
            ...
            Text = "EntityA_U"
            ClientSize = New Size(600, 223)
            okButton.Location = New Point(ClientSize.Width - 272, ClientSize.Height - 46)
            ...
            middleNameTextBox = AddField("MiddleName", 62, False, False)
        ...
        Protected Overrides Sub BindToFormInternal()
            ...
            For Each control In New Control() {firstNameTextBox, middleNameTextBox, lastNameTextBox, address1TextBox}
        ...
        Protected Overrides Function SaveRecord() As Boolean
            ...
            values("MiddleName") = middleNameTextBox.Text
