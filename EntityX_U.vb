...
Namespace HelloWorld
    Public Class EntityX_U
        ...
        Private ReadOnly birthDateTextBox As TextBox
        ...
        Public Sub New(id As Integer, user As UserContext, Optional profile As AccessProfile = Nothing)
            ...
            lastNameTextBox = AddField("LastName", 62, False, False)
            address1TextBox = AddField("Address1", 104, False, False)
            birthDateTextBox = AddField("BirthDate", 146, False, False)
            BindToForm()
            ApplyMode()
        End Sub
        ...
        Protected Overrides Sub BindToFormInternal()
            ...
            For Each control In New Control() {firstNameTextBox, lastNameTextBox, address1TextBox, birthDateTextBox}
        ...
        Protected Overrides Function SaveRecord() As Boolean
            ...
            values("BirthDate") = birthDateTextBox.Text
